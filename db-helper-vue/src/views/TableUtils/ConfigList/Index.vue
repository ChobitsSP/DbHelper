  ...
  <div>
    <el-row>
      <el-col :xs="{ span: 24, offset: 0 }" :sm="{ span: 20, offset: 2 }" :md="{ span: 16, offset: 4 }"
        :lg="{ span: 12, offset: 6 }" :xl="{ span: 10, offset: 7 }">
        <el-row>
          <el-form inline>
            <el-form-item>
            ...
            <el-form-item>
              <el-button @click="exportConfig" circle icon="el-icon-download" size="small" type="info"></el-button>
            </el-form-item>
            <el-form-item>
        ...
        <el-row>
          <el-table :data="tableData" border size="small" style="width: 100%">
            ...
            <el-table-column prop="providerName" label="provider" min-width="220">
            </el-table-column>
              ...
              <template slot-scope="{ row }">
                <el-dropdown @command="cmd => onCommand(row, cmd)">
                  ...
                  <el-dropdown-menu slot="dropdown">
                    <el-dropdown-item icon="el-icon-edit" command="edit">编辑
                    </el-dropdown-item>
                    <el-dropdown-item icon="el-icon-download" command="exportAll">导出
                    </el-dropdown-item>
                    <el-dropdown-item icon="el-icon-s-grid" command="exportDatas">导出数据
                    </el-dropdown-item>
                    <el-dropdown-item icon="el-icon-s-grid" command="exportMd">导出md
                    </el-dropdown-item>
                    <el-dropdown-item icon="el-icon-eleme" command="exportEf">ef
                    </el-dropdown-item>
                    <el-dropdown-item icon="el-icon-remove" command="remove">删除
                    </el-dropdown-item>
                  </el-dropdown-menu>
                </el-dropdown>
  ...
  methods: {
    ...
    async importColComment(list, row) {
      ...
      for (let i = 0; i < list.length; i++) {
        ...
        const rsp = await axios.post("/api/sql/UpdateColumnComment", item);
        if (rsp.code !== 0) {
          console.error({
            item,
            error: rsp.msg,
